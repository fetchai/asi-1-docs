...
- [Rest endpoints with an Agent](/docs/guides/rest_endpoints)
...
![](../../../../content/images/guides/uagents/anthropic/output1.png)

![](../../../../content/images/guides/uagents/anthropic/output2.png)
