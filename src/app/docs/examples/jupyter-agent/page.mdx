...
**Jupyter notebook** natively supports asyncio, and as [Agents](/docs) are asynchronous by design, Jupyter and Agents work together with ease.

Please check out the example code in our [examples repo](https://github.com/fetchai/uAgent-Examples/tree/main/3-applications/jupyter-notebook) to run this locally.
...
Are you new to Agents? To understand the agent in this example, please read [communicating with agents](/docs/getting-started/communication)
