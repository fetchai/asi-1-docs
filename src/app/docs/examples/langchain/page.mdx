...
Fetch.ai creates a dynamic communication layer that allows you to abstract away components into individual [Agents](/docs). Agents are micro-services that are programmed to communicate with other agents, and or humans. By using **Agents** to represent different parts of your **Langchain** program you give your project the option to be used by [other parties](/docs/getting-started/communication) for economic benefit.
...
You can read more about agents communication in our [guides](/docs/getting-started/communication)
...
Check out more detailed instructions for [installation](/docs/getting-started/install) of `uagents` library on your end.
...
There are more options for the `Agent` class; see [`Agent` Class](/refs/api/agent) for further reference.
...
To learn more about communication with other agents check out the following [Guide](/docs/getting-started/communication)
