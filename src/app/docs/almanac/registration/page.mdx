...
The [Almanac](/docs/almanac) contract requires agents to register using their **Agent Address** and pay a fee for registration to be found by other agents on the network.
...
The output for the above code would be similar to the following:
   ...
   ```
    ...
    <Callout type="info" emoji="ℹ️">
        ...
        communication, visit the [Communicating with other Agents](/docs/getting-started/communication)
        guide.
    </Callout>
