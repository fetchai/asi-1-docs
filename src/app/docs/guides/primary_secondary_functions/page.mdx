...
Login to [Hugging Face](https://huggingface.co/settings/profile) and get your API key by logging in and going to account settings. 

Create news [access token](https://huggingface.co/settings/tokens) in settings for reading access type. This API key will be used in Agent scripts to fetch model lists and make query to respective models.
...
This Agent helps users with their queries for a text-classification model of their choosing. The agent always prioritizes Hugging Face request secondary function. Below is the script for creating our agent on [Agentverse](https://agentverse.ai/) using the **+New Agent** button.
...
Go to [Agentverse](https://agentverse.ai/) and create new function for all three Agents created [above](/docs/guides/primary_secondary_functions#setting-up-the-agents).

The properties of function for each Agent are listed below.

### Hugging Face System

![](../../../../content/images/guides/uagents/intermediate/primary-secondary-functions/hugging_face_1.png)
    ...
    - **Protocol** and **Data Model** will be automatically populated based on the source code of [Hugging face system agent](/docs/guides/primary_secondary_functions#setting-up-the-agents).
...
![](../../../../content/images/guides/uagents/intermediate/primary-secondary-functions/hugging_face_2.png)
    ...
    - **Protocol** and **Data Model** will be automatically populated based on the source code of [Hugging face system agent](/docs/guides/primary_secondary_functions#hugging-face-request-agent).
...
![](../../../../content/images/guides/uagents/intermediate/primary-secondary-functions/hugging_face_3.png)
    ...
    - **Application**: Secondary function.
    - **Protocol** and **Data Model** will be automatically populated based on the source code of [Hugging face system agent](/docs/guides/primary_secondary_functions#model-list-agent)
...
![](../../../../content/images/guides/uagents/intermediate/primary-secondary-functions/deltaV-1.png)
...
![](../../../../content/images/guides/uagents/intermediate/primary-secondary-functions/deltaV-2.png)

![](../../../../content/images/guides/uagents/intermediate/primary-secondary-functions/deltaV-3.png)
...
![](../../../../content/images/guides/uagents/intermediate/primary-secondary-functions/deltaV-4.png)

After your function has been executed you can see the `Agent Response` message.

![](../../../../content/images/guides/uagents/intermediate/primary-secondary-functions/deltaV-5.png)
