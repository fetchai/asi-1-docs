...
This system is pretty simple, as to get you started as quickly as possible. We're going to run this Agent on any device you'd like, in this scenario we're running on a VM, but you could run this on your laptop, raspberry pi or tweak for Agentverse. On startup our script will register our Agent to the [Almanac](/docs/almanac), and then our Agent will be available to communicate with other Agents.
...
Through the **Agentverse** you can set up [Mailboxes](/docs/agentverse/mailbox) for your local Agents, allowing them to communicate with other Agents registered on the Fetch Network without the need to be constantly online and without requiring your constant presence to operate.
