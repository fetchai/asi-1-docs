...
# Make your agents AI Engine compatible
 ...
 In the previous resource, ([Agent functions](/docs/agentverse/functions)) we created a simple agent that
 returned a dice roll, however this agent was already ready to be callable by [AI Engine](https://fetch.ai/docs/concepts/ai-engine/ai-engine-intro). Let's get into how.
...
1. `UAgentResponseType()`:
    ...
    - We used `FINAL` in our [dice roll](https://github.com/fetchai/uAgent-Examples/tree/main/1-uagents/docs_examples/intermediate/dice-roll) example:
