...
For a better understanding of these concepts, consider having a look at the [Agents storage](/docs/getting-started/storage) and [Exchange protocol](https://fetch.ai/docs/references/uagents/uagents-protocols/exchange-protocol#exchange-protocol) resources and consider going through the extensive [How to book a table at a restaurant using agents](https://fetch.ai/docs/examples/table-booking-demo) guide. Also, check out the [Agents: broadcast](/docs/guides/broadcast) guide for an additional implementation of protocols in Agents communication.