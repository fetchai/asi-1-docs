...
import PublicAndPrivateAgents from '../../../../content/images/guides/uagents/intermediate/private-public-agents/public_and_private_agents.png'
import DarkPublicAndPrivateAgents from '../../../../content/images/guides/uagents/intermediate/private-public-agents/dark_public_and_private_agents.svg'

# Public and private agents

## Introduction

Transparency is a fundamental principle in Decentralized Finance (DeFi) and blockchain systems. Within the Fetch.ai network, **users have the ability to determine the amount of information they wish to publish**. This is thanks to the ability for users to create Agents as either **public** or **private**, based on their **introspectivity** and **[protocol](/docs/guides/protocols) exposure** through the [Agentverse](https://fetch.ai/docs/concepts/agent-services/agentverse-intro).
