...
![](../../../../content/images/guides/uagents/advanced/utilizing-api-to-build-network-of-task-and-subtask/News_Reading_System_Workflow.png)

First of all, we have the **News Reading URL System**; this one acts as the gateway to news headlines. This layer enables the connection between users and the latest news headlines. When the user expresses interest in reading the news, the [AI Engine](https://fetch.ai/docs/concepts/ai-engine/ai-engine-intro) drives the News Reading System and initiates the process of fetching news articles for the user. Once the system understands your intent is to read news headlines, it will call upon the **News Reading Details Secondary function**. At this point, users will be required to provide the news type and subtype they want to read via [DeltaV](https://fetch.ai/docs/concepts/ai-engine/deltav).
...
## Imports needed
    ...
    - [AI Engine](https://pypi.org/project/uagents-ai-engine/)
...
Refer to the [Functions](/docs/agentverse/functions) for more details on Primary and Secondary functions. Also, have a look at the [Agentverse Functions](https://fetch.ai/docs/guides/agentverse/agentverse-functions/field-descriptions-for-deltav) for guidance on fields descriptions of your Agent Functions!

## News API

Login to [News API](https://newsapi.org/docs/endpoints/top-headlines) and get your API key by logging in and registering for API. This API key will be used in agent scripts to fetch news related to a specific type and subtype.

### News Reading URL System Agent

This agent helps users to read news according to their willingness. This agent triggers the news details gathering secondary functions and asks the user for the news type and subtype they want to read today. This agent responds to the final result to the [DeltaV](https://fetch.ai/docs/concepts/ai-engine/deltav) GUI as well.
...
Let's navigate to the [Agentverse](https://agentverse.ai) to start registering your agent Functions.

    <Callout type="info" emoji="ℹ️">
      For further information on Agent Functions and registration process, see [Register Agent Functions on the Agentverse](https://fetch.ai/docs/guides/agentverse/agentverse-functions/registering-agent-services) resource.

    </Callout>

Considering the local agents in this guide, in order to register **Local Agents and respective Functions** on the Agentverse, you will first need to log in the [Agentverse](https://agentverse.ai/) and head over to the **My Agents** tab. Then, click on **Local Agents** tab and click one of the **Connect Local Agent** buttons.

![](../../../../content/images/guides/uagents/intermediate/functions/servicefordungeons_1.png)
...
![](../../../../content/images/guides/uagents/intermediate/functions/servicefordungeons_2.png)
...
### News Reading URL System
    ...
    - **Protocol** and **Data Model** will be automatically populated based on the source code of [your news reading system agent](/docs/guides/network_primary_secondary_functions#news-reading-url-system-agent).
    - **Field descriptions**:
...
### News Reading Details Secondary function
    ...
    - **Protocol** and **Data Model** will be automatically populated based on the source code of [your news generating agent](/docs/guides/network_primary_secondary_functions#news-reading-details-agent).
...
### Generate Categorical News 
    ...
    - **Application**: Secondary function.
    - **Protocol** and **Data Model** will be automatically populated based on the source code of [your generate categorical Agent](/docs/guides/network_primary_secondary_functions#generate-categorical-news).
    - **Field descriptions**:
...
### Generate Regional News Secondary function
    ...
    - **Protocol** and **Data Model** will be automatically populated based on the source code of [your generate regional Agent](/docs/guides/network_primary_secondary_functions#generate-regional-news).
    - **Field descriptions**:
...
### Generate Keyword News Secondary function
    ...
    - **Application**: Secondary function.
    - **Protocol** and **Data Model** will be automatically populated based on the source code of [your generate keyword Agent](/docs/guides/network_primary_secondary_functions#generate-keyword-news).
    - **Field descriptions**:
...
Now, head to [DeltaV](https://deltav.agentverse.ai/) and sign in.
...
![](../../../../content/images/guides/uagents/advanced/utilizing-api-to-build-network-of-task-and-subtask/querying-deltaV-for-reading-news.png)
...
![](../../../../content/images/guides/uagents/advanced/utilizing-api-to-build-network-of-task-and-subtask/selection-of-news-reading-system-service.png)
...
![](../../../../content/images/guides/uagents/advanced/utilizing-api-to-build-network-of-task-and-subtask/news-reading-details-subtask.png)

![](../../../../content/images/guides/uagents/advanced/utilizing-api-to-build-network-of-task-and-subtask/news-reading-details-subtask-2.png)

Once you select the news type respective Secondary functions will be triggered as mentioned in [objective description](/docs/guides/network_primary_secondary_functions#news-reading-details-secondary-function) for **Generate news_type secondary function**.
...
![](../../../../content/images/guides/uagents/advanced/utilizing-api-to-build-network-of-task-and-subtask/generate-news-type-subtask-3.png)

![](../../../../content/images/guides/uagents/advanced/utilizing-api-to-build-network-of-task-and-subtask/generate-news-type-subtask-4.png)

![](../../../../content/images/guides/uagents/advanced/utilizing-api-to-build-network-of-task-and-subtask/generate-news-type-subtask-5.png)

![](../../../../content/images/guides/uagents/advanced/utilizing-api-to-build-network-of-task-and-subtask/generate-news-type-subtask-6.png)
