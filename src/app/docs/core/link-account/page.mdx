...
Click **Add new wallet**, and select a wallet provider. 

You can choose between [ASI Wallet](https://fetch.ai/docs/guides/fetch-network/asi-wallet/web-wallet/get-started) and [Metamask](https://metamask.io/en-GB). In this example we use ASI Wallet:
