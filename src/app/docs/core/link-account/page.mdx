...
Click **Add new wallet**, and select a wallet provider. You can choose between [ASI Wallet](https://network.fetch.ai/docs/guides/asi-wallet/web-wallet/get-started) and [Metamask](https://metamask.io/en-GB). 
